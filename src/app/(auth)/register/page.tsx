      ...
      <div className="w-full max-w-md">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="font-heading font-bold text-2xl" style={{ color: 'var(--color-text)' }}>3ZF Platform</span>
          </Link>
          <h1 className="font-heading text-3xl font-bold" style={{ color: 'var(--color-text)' }}>
            {step === 'form' ? 'Create Account' : 'Verify Email'}
          </h1>
          <p className="mt-2 text-sm" style={{ color: 'var(--color-text-secondary)' }}>
            {step === 'form' ? 'Join the 3ZF community today' : 'Enter the 6-digit code sent to your email'}
          </p>
        </motion.div>
              ...
              <motion.form key="form" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" placeholder="Your full name" {...register('name')} style={{ paddingLeft: '2.5rem' }} />
                  </div>
                ...
                {/* Phone */}
                <div>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--color-text)' }}>Phone (Optional)</label>
                  <div className="relative">
                    <Phone className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none"
                      style={{ color: 'var(--color-text-muted)' }} />
                    <input type="tel" placeholder="+880 1XXXXXXXXX" {...register('phone')} style={{ paddingLeft: '2.5rem' }} />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none"
                      style={{ color: 'var(--color-text-muted)' }} />
                    <input type={showPass ? 'text' : 'password'} placeholder="At least 6 characters" {...register('password')}
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none"
                      style={{ color: 'var(--color-text-muted)' }} />
                    <input type="password" placeholder="Repeat password" {...register('confirmPassword')} style={{ paddingLeft: '2.5rem' }} />
                  </div>
          ...
          {step === 'form' && (
            <div className="mt-5 pt-5 border-t text-center" style={{ borderColor: 'var(--color-border)' }}>
              <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                ...
                <Link href="/login" className="font-semibold" style={{ color: 'var(--color-brand)' }}>Sign In</Link>
              </p>
            </div>
          )}
        </motion.div>
