...
// 1. Logic extracted into a sub-component
...
// 2. Default export providing the Suspense Boundary
export default function PaymentFailedPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--color-bg-secondary)' }}>
      <Suspense fallback={<div className="animate-pulse text-gray-500">Processing...</div>}>
