...
import { ArrowRight, Wheat, Home, BookOpen, Sun, Moon } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    <section
      className="relative overflow-hidden min-h-screen flex items-center pt-20 pb-16 px-4"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="block text-2xl md:text-3xl mt-2" style={{ color: 'var(--color-text)' }}>
            ...
            {/* Tagline */}
            <p
              className="italic text-base mb-4 leading-relaxed"
            ...
            >
              ...
              principles — Zero Interest, Zero Exploitation, and Zero Ignorance. Together, we work
              towards financial freedom, social dignity, and knowledge-based empowerment for all.
            </p>
            ...
            <div className="flex flex-col gap-3 mb-8">
              {pillars.map((p, i) => (
                ...
                >
                  <div
                    className={`w-9 h-9 rounded-xl bg-gradient-to-br ${p.color} flex items-center justify-center flex-shrink-0`}
                  >
                    <p.icon className="w-4 h-4 text-white" />
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-sm" style={{ color: 'var(--color-brand-light, #805AD5)' }}>
                      {p.en}
                    </p>
