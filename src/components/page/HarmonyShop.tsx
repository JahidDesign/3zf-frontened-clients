  ...
  return (
    <main className="hs-root">
      ...
      <section className="hs-hero">
        ...
        <div className="hs-wrap hs-hero-inner">
          <motion.div {...fadeUp(0)} className="hs-hero-left">
            ...
            <div className="hs-btn-row">
              <button className="hs-btn-p">Join Community <ArrowRight size={15} /></button>
          ...
          <motion.div {...fadeUp(0.15)} className="hs-card hs-vision">
            ...
            <div className="hs-stats">
              {[["৬৪+", "জেলা"], ["৩", "শূন্য লক্ষ্য"], ["১", "ন্যায্য বাজার"]].map(([v, l]) => (
                <div key={l} className="hs-stat">
                  <span className="hs-stat-v">{v}</span>
      ...
      <motion.section {...fadeUp(0)} className="hs-sec">
        <div className="hs-wrap hs-two-col">
          <div>
            ...
            <h2 className="hs-h2">বাজারের <span className="hs-accent">অসুস্থতা</span></h2>
      ...
      <section className="hs-sec hs-alt">
        <div className="hs-wrap">
          ...
          <h2 className="hs-h2">কীভাবে <span className="hs-accent">কাজ করে?</span></h2>
      ...
      <section className="hs-sec">
        <div className="hs-wrap">
          ...
          <h2 className="hs-h2">আমরা কী <span className="hs-accent">দিচ্ছি?</span></h2>
          <div className="hs-rule" style={{ marginBottom: 'clamp(1.2rem,3.5vw,2rem)' }} />
          <div className="hs-4col">
      ...
      <section className="hs-sec hs-alt">
        <div className="hs-wrap">
          ...
          <h2 className="hs-h2">মৌলিক চাহিদা <span className="hs-accent">পূরণ</span></h2>
          <div className="hs-rule" style={{ marginBottom: 'clamp(1.2rem,3.5vw,2rem)' }} />
      ...
      <motion.section {...fadeUp(0)} className="hs-sec hs-center">
        <div className="hs-wrap hs-center">
          ...
          <h2 className="hs-h2">আমাদের <span className="hs-accent">দর্শন</span></h2>
          <div className="hs-rule hs-rule-c" />
          <p className="hs-phil-p">
            এই উদ্যোগ বৃহত্তর সামাজিক দর্শন{' '}
            <strong className="hs-accent">3ZF (Three Zeros of Freedom)</strong>
            -এর সাথে সামঞ্জস্যপূর্ণ। অর্থনীতি যদি সুদমুক্ত, শোষণমুক্ত ও জ্ঞানভিত্তিক হয় — তবেই প্রকৃত স্বাধীনতা সম্ভব।
          </p>
          <div className="hs-3col">
            {zeroItems.map((z, i) => (
      ...
      <section className="hs-sec hs-alt">
        <div className="hs-wrap" style={{ maxWidth: '50rem' }}>
          ...
          <h2 className="hs-h2">হারমনি শপ কী <span className="hs-accent">আলাদা করে?</span></h2>
          <div className="hs-rule" style={{ marginBottom: 'clamp(1.2rem,3.5vw,2rem)' }} />
          <div className="hs-diff-list">
            {diffItems.map((item, i) => (
              <motion.div key={i} {...fadeUp(i * 0.08)} className="hs-diff-item">
                <div className="hs-check"><Check size={13} /></div>
                <span>{item}</span>
              </motion.div>
            ))}
          </div>
          <div className="hs-stmt">
            ...
            <p><span className="hs-accent">এটি একটি সামাজিক অবকাঠামো।</span></p>
          </div>
        </div>
      </section>
      ...
      <section className="hs-sec">
        <div className="hs-wrap">
          ...
          <h2 className="hs-h2">ন্যায্য সমাজের <span className="hs-accent">তিন স্তম্ভ</span></h2>
          <div className="hs-rule" style={{ marginBottom: 'clamp(1.2rem,3.5vw,2rem)' }} />
      ...
      <motion.section {...fadeUp(0)} className="hs-sec hs-alt hs-center">
        <div className="hs-wrap hs-center">
          ...
          <h2 className="hs-h2">এই উদ্যোগ <span className="hs-accent">কার জন্য?</span></h2>
          <div className="hs-rule hs-rule-c" />
          <div className="hs-tags">
            {whoTags.map((tag) => (
              <span key={tag} className="hs-tag">{tag}</span>
            ))}
          </div>
        </div>
      </motion.section>
      ...
      <footer className="hs-footer">
        ...
        <div className="hs-wrap hs-center" style={{ position: 'relative' }}>
          ...
          <h2 className="hs-footer-h">
            &ldquo;ন্যায্য বাজার গড়া <span style={{ color: 'var(--hs-b2)' }}>সম্ভব</span>&rdquo;
          </h2>
          <p className="hs-footer-pledge">
            আমরা প্রতিশ্রুতি দিচ্ছি না যে একদিনেই সমাজ বদলে যাবে।<br />
            আমরা প্রমাণ করতে চাই — <strong>ন্যায্য বাজার গড়া সম্ভব।</strong><br />
          ...
          <button className="hs-btn-p hs-footer-btn">
      ...
      <style>{`
        ...
        .hs-h2    { font-size: clamp(1.25rem,3.6vw,1.95rem); font-weight: 700; color: var(--hs-tx); margin: 0 0 .4rem; line-height: 1.2; }
        .hs-accent{ color: var(--hs-b); }
        .hs-rule  { width: 2.5rem; height: 2px; border-radius: 9999px; background: linear-gradient(90deg, var(--hs-b), transparent); margin-top: .4rem; }
        .hs-rule-c{ margin: .4rem auto 0; }
        .hs-num   { color: var(--hs-b); font-weight: 700; font-size: clamp(.68rem,1.5vw,.78rem); }
        .hs-emoji { font-size: clamp(1.4rem,3.2vw,1.9rem); }
        .hs-card-h{ font-weight: 700; color: var(--hs-tx); font-size: clamp(.78rem,1.9vw,.9rem); margin: 0; }
        .hs-card-p{ color: var(--hs-mt); font-size: clamp(.7rem,1.7vw,.8rem); line-height: 1.65; margin: 0; }

        /* ── Card ── */
        .hs-card  { background: var(--hs-cd); border: 1px solid var(--hs-ce); border-radius: 1rem; transition: transform .2s, border-color .2s; }
        ...
        .hs-btn-p {
          ...
          font-weight: 600; cursor: pointer; box-shadow: 0 4px 20px rgba(124,58,237,.35);
          transition: transform .18s, box-shadow .18s;
          font-size: clamp(.75rem,1.9vw,.9rem);
          padding: clamp(10px,2.2vw,13px) clamp(18px,3.5vw,28px);
        }
        .hs-btn-p:hover { transform: translateY(-2px); box-shadow: 0 8px 30px rgba(124,58,237,.5); }
        .hs-btn-s {
        ...
        .hs-orb {
          ...
          filter: blur(90px); opacity: .12; background: var(--hs-b);
          width: clamp(220px,44vw,500px); height: clamp(220px,44vw,500px);
          top: -4rem; right: -4rem;
        }
        .hs-grid-bg {
          position: absolute; inset: 0; pointer-events: none; opacity: .03;
          background-image: linear-gradient(var(--hs-b) 1px, transparent 1px), linear-gradient(90deg, var(--hs-b) 1px, transparent 1px);
          background-size: clamp(36px,5vw,52px) clamp(36px,5vw,52px);
        }
        .hs-hero-inner { display: grid; grid-template-columns: 1fr; gap: clamp(2rem,5vw,3.5rem); position: relative; align-items: center; }
        @media (min-width: 820px) { .hs-hero-inner { grid-template-columns: 1fr 1fr; } }
        .hs-hero-left  { display: flex; flex-direction: column; }
        .hs-hero-h1    { font-size: clamp(2.8rem,8vw,5.5rem); font-weight: 800; line-height: 1; margin: 0 0 .5rem; }
        .hs-grad {
          display: block;
          background: linear-gradient(135deg, var(--hs-b) 0%, var(--hs-b2) 100%);
          -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
        }
        .hs-hero-sub  { display: block; color: var(--hs-tx); margin-top: .1rem; }
        .hs-hero-tag  { color: var(--hs-mt); margin: .75rem 0 0; font-size: clamp(.8rem,2vw,.95rem); }

        /* Vision card */
        .hs-vision      { padding: clamp(1.2rem,3vw,1.8rem); }
        .hs-vision-label{ color: var(--hs-b); font-weight: 600; font-size: .85rem; margin-bottom: .6rem; }
        .hs-vision-body { color: var(--hs-mt); font-size: clamp(.78rem,1.9vw,.9rem); line-height: 1.7; margin: 0 0 1.2rem; }
        .hs-stats       { display: flex; gap: 1rem; border-top: 1px solid var(--hs-ce); padding-top: 1rem; }
        .hs-stat        { display: flex; flex-direction: column; }
        .hs-stat-v      { font-size: clamp(1.1rem,3vw,1.5rem); font-weight: 700; color: var(--hs-b); }
        .hs-stat-l      { font-size: .7rem; color: var(--hs-mt); }
        ...
        .hs-prob-n { color: var(--hs-b); font-weight: 700; font-size: .78rem; flex-shrink: 0; }
        .hs-belief { padding: clamp(1.2rem,3vw,2rem); text-align: center; }
        .hs-belief-icon{ font-size: 2rem; margin-bottom: .75rem; }
        .hs-belief-lbl { color: var(--hs-b); font-weight: 600; margin-bottom: .5rem; font-size: .85rem; }
        .hs-belief-txt { color: var(--hs-mt); font-size: clamp(.78rem,1.9vw,.9rem); line-height: 1.7; }
        ...
        .hs-need .hs-emoji { margin-top: .1rem; }

        /* Philosophy */
        .hs-phil-p {
          color: var(--hs-mt); font-size: clamp(.78rem,1.9vw,.9rem); line-height: 1.75;
          max-width: 46rem; margin: .75rem auto 2rem;
        }
        ...
        .hs-zero-n  { font-size: clamp(1.8rem,4vw,2.4rem); font-weight: 800; color: var(--hs-b); opacity: .22; line-height: 1; }
        .hs-zero-en { font-weight: 700; color: var(--hs-tx); font-size: clamp(.82rem,2vw,.95rem); margin: 0; }
        .hs-zero-bn { color: var(--hs-mt); font-size: clamp(.72rem,1.7vw,.82rem); margin: 0; }
        ...
        .hs-stmt { border-left: 2px solid var(--hs-b); padding-left: 1rem; }
        .hs-stmt p { margin: 0 0 .2rem; font-size: clamp(.82rem,2vw,.95rem); color: var(--hs-mt); }

        /* Outcomes */
        .hs-outcomes { display: flex; flex-direction: column; gap: .6rem; }
        .hs-outcome  { display: flex; align-items: center; gap: .75rem; font-size: clamp(.75rem,1.9vw,.88rem); color: var(--hs-mt); }
        .hs-dot      { flex-shrink: 0; width: .5rem; height: .5rem; border-radius: 9999px; background: var(--hs-b); }
        ...
        .hs-tag  {
          ...
          border: 1px solid var(--hs-cb); background: var(--hs-ca);
          color: var(--hs-b); font-size: clamp(.74rem,1.8vw,.86rem); font-weight: 500;
          transition: background .18s, transform .18s; cursor: default;
        }
        .hs-tag:hover { background: rgba(124,58,237,.2); transform: translateY(-2px); }

        /* ════ FOOTER ════ */
        .hs-footer {
          position: relative; overflow: hidden; text-align: center;
          background: linear-gradient(135deg, #1a0d3a 0%, #0f0d18 100%);
        ...
        .hs-footer-h {
          font-size: clamp(1.6rem,5vw,3rem); font-weight: 800; color: var(--hs-tx); margin: 0 0 1.25rem;
        }
        .hs-footer-pledge {
          color: var(--hs-mt); line-height: 1.9; max-width: 38rem;
          font-size: clamp(.8rem,2vw,.95rem); margin: 0 0 1.25rem;
        }
        .hs-footer-q {
          color: var(--hs-mt); font-size: clamp(.78rem,1.9vw,.9rem);
          line-height: 1.75; max-width: 36rem; margin: 0 0 2rem;
        }
        ...
        .hs-copy {
          ...
          color: var(--hs-mt); font-size: clamp(.6rem,1.4vw,.72rem); margin-top: 2rem; opacity: .65;
        }
